const meniuBtn = document.getElementById("meniu-btn");
...
function checkout() {
    const confirmationMessage = "Your order has been submitted.Thank you!"
    wrp.innerHTML = `<p>${confirmationMessage}</p>`;
    indicator.style.display = "none";
...
meniuBtn.addEventListener("click", openMeniu);
closeBtn.addEventListener("click", closeMeniu);
